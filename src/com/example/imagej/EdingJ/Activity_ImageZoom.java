...
//		        i.putExtras(b);  
				Intent aintent = new Intent(Activity_ImageZoom.this, MainActivity.class);
		...
		//载入显示模板
		try {
			strFormat_ImageZoom = Global.GetString(Activity_ImageZoom.this.getAssets().open("imagezoom.html"));
		} catch (IOException e) {
